...
export const PLAZA: Tileset = {
  ...
  tiles: [
    ...
    { id: 'setts', name: 'Granite setts', kind: 'floor', category: 'ground', pattern: 'cobble', colors: ['#766c5c', '#837866'] },
    { id: 'paving', name: 'Paving slabs', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#82796a', '#8f8574'] },
    { id: 'lawn', name: 'Clipped lawn', kind: 'floor', category: 'ground', pattern: 'grass', colors: ['#5c6a42', '#68774b'] },
    { id: 'basin', name: 'Fountain basin', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4a6064', '#576f74'], hint: 'Knee-deep. Reflects the lamps.' },
    { id: 'road', name: 'Plaza road', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#52493f', '#5f554a'] },
    { id: 'lamppool', name: 'Lamp pool', kind: 'floor', category: 'ground', pattern: 'cobble', colors: ['#8f7d5e', '#9a8766'], emissive: '#ffb648' },
...
export const PARK: Tileset = {
  ...
  tiles: [
    ...
    { id: 'pond', name: 'Pond', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#465c5c', '#536b6c'] },
    { id: 'reeds', name: 'Pond margin', kind: 'floor', category: 'ground', pattern: 'reeds', colors: ['#5a6a4a', '#667753'] },
    { id: 'deck', name: 'Bandstand deck', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#83694a', '#8f7352'] },
...
export const MARINA: Tileset = {
  ...
  tiles: [
    ...
    { id: 'planking', name: 'Pier planking', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7f6a4e', '#8b7556'] },
    { id: 'wetplank', name: 'Wet planking', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#5f5340', '#6a5d48'], sheen: '#ffb648', hint: 'Slick. The ruler does not care, but you might.' },
    { id: 'quay', name: 'Concrete quay', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#7a7060', '#877c6b'] },
    { id: 'harbour', name: 'Harbour water', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#3e5559', '#4a6368'], hint: 'Cold and deep. Swimming is a test.' },
    { id: 'shallows', name: 'Shallows', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4f6466', '#5c7274'] },
    { id: 'slipway', name: 'Slipway', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#6a6759', '#777463'] },
    { id: 'docklamp', name: 'Dock lamp pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#907a58', '#9b8460'], emissive: '#ffb648' },
    ...
    { id: 'skiff', name: 'Skiff', kind: 'feature', category: 'interior', pattern: 'planks', colors: ['#7f6a4c', '#8b7554'], height: WAIST, prop: 'canoe', placement: { on: ['harbour', 'shallows', 'slipway'] } },
...
export const COUNTRYSIDE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'pond', name: 'Farm pond', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4c5f56', '#586d63'] },
...
export const LAKE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'shore', name: 'Shingle shore', kind: 'floor', category: 'ground', pattern: 'sand', colors: ['#847660', '#91826a'] },
    { id: 'jetty', name: 'Jetty boards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7f6a4e', '#8b7556'] },
    { id: 'cabinfloor', name: 'Cabin boards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#846b4a', '#907552'] },
    { id: 'deep', name: 'Deep water', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#364e55', '#425c63'], hint: 'Black at night. Anything dropped here is gone.' },
    { id: 'shallow', name: 'Shallows', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4d6266', '#5a7074'] },
    { id: 'reeds', name: 'Reed bed', kind: 'floor', category: 'ground', pattern: 'reeds', colors: ['#5a6748', '#667551'], hint: 'Cover for a boat, and for whoever is waiting in one.' },
    { id: 'pine', name: 'Pine needles', kind: 'floor', category: 'ground', pattern: 'dirt', colors: ['#6a5a45', '#77664d'] },
    { id: 'lamppool', name: 'Lantern pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#917a56', '#9c845e'], emissive: '#e6d58a' },
    ...
    { id: 'canoe', name: 'Canoe', kind: 'feature', category: 'interior', pattern: 'planks', colors: ['#8a5f45', '#96684c'], height: WAIST, prop: 'canoe', placement: { on: ['deep', 'shallow', 'shore'] } },
