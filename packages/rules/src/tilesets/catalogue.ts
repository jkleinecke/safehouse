...
export const DOCKLANDS: Tileset = {
  ...
  tiles: [
    ...
    { id: 'floor', name: 'Poured concrete', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'concrete', colors: ['#7c6b56', '#907d64'] },
    { id: 'stain', name: 'Oil-stained slab', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'concrete', colors: ['#4d4237', '#625545'], hint: 'Same footing, worse-looking footing.' },
    { id: 'grate', name: 'Drain grating', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'grating', colors: ['#6c644f', '#81765f'] },
    { id: 'lamp', name: 'Sodium lamp pool', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'concrete', colors: ['#a4865f', '#a4855f'], emissive: '#ffaf2e', hint: 'Lit ground — anyone standing here is visible.' },
    ...
    { id: 'catwalk', name: 'Steel mesh', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'grating', colors: ['#6a5f4c', '#7a6e58'], hint: 'Catwalk decking — you can see the floor through it.' },
    ...
    { id: 'street', name: 'Access road', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'gravel', colors: ['#4a4038', '#5b5047'] },
    { id: 'sidewalk', name: 'Loading apron', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#8a7a64', '#9b8a71'] },
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#9a8b74', '#a0917b'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Caged lamp', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#6d6352', '#7a6f5c'], emissive: '#ffc76a', footprint: 'post', prop: 'pendant', placement: { on: ['floor', 'stain', 'grate', 'lamp'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
  ],
};
...
export const CORP_INTERIOR: Tileset = {
  ...
  tiles: [
    ...
    { id: 'carpet', name: 'Executive carpet', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'carpet', colors: ['#645d56', '#6f6860'] },
    { id: 'lobby', name: 'Polished lobby', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'tile', colors: ['#9e9a8e', '#a49f94'], hint: 'Bright, hard, and it echoes.', sheen: '#f2dfa8' },
    { id: 'raised', name: 'Raised server floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'hatch', colors: ['#928b82', '#9d968c'], hint: 'Cable runs underneath — a decker will ask.' },
    ...
    { id: 'hall', name: 'Corridor tile', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'tile', colors: ['#8d8a80', '#99968c'], hint: 'The bit between the rooms. Cameras live here.' },
    ...
    // Every set has a street, a sidewalk and the kerb between them, and a light for indoors.
    { id: 'street', name: 'Access road', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'gravel', colors: ['#4b4744', '#5a5652'] },
    { id: 'sidewalk', name: 'Plaza paving', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'tile', colors: ['#9a968c', '#a19d93'] },
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#9e9a90', '#a4a096'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Ceiling panel', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#96928a', '#a19d93'], emissive: '#e8d9a0', footprint: 'post', prop: 'pendant', placement: { on: ['carpet', 'lobby', 'raised', 'hall'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
  ],
};
...
export const SPRAWL_STREET: Tileset = {
  ...
  tiles: [
    ...
    { id: 'road', name: 'Cracked asphalt', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'gravel', colors: ['#484039', '#5c524a'] },
    { id: 'walk', name: 'Pavement', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'tile', colors: ['#7c6c5b', '#907e6b'] },
    { id: 'grass', name: 'Verge grass', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'grass', colors: ['#5b6242', '#6e7651'], hint: 'What passes for a park out here.' },
    { id: 'puddle', name: 'Standing water', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'water', colors: ['#5c4f45', '#716253'], hint: 'Reflects the neon. Makes noise.', sheen: '#e04fb8' },
    { id: 'neon', name: 'Neon spill', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'solid', colors: ['#9b6d56', '#a4755b'], emissive: '#f531b4', hint: 'Lit ground, and it colours everyone standing in it.' },
    ...
    { id: 'sewer', name: 'Sewer grating', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'grating', colors: ['#4d453c', '#62574d'], hint: 'Somewhere under the street, something is running.' },
    ...
    { id: 'alley', name: 'Alley concrete', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#4a4139', '#584d44'], hint: 'Behind the shops. Nobody looks down here.' },
    ...
    // Every set has a street, a sidewalk and the kerb between them, and a light for indoors.
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#8f8170', '#9d8e7c'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Bare bulb', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#6a5e50', '#776a5b'], emissive: '#ffbe4a', footprint: 'post', prop: 'pendant', placement: { on: ['alley', 'sewer'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
    { id: 'shopfloor', name: 'Shop floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'tile', colors: ['#7a6a58', '#877664'], hint: 'Inside the storefronts and stairwells off the street.' },
  ],
};
...
export const MAINTENANCE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'duct', name: 'Duct floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'panel', colors: ['#6c634b', '#81765a'] },
    { id: 'walkway', name: 'Grated walkway', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'grating', colors: ['#81745a', '#968668'] },
    { id: 'sludge', name: 'Sludge channel', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'water', colors: ['#485739', '#586c48'], emissive: '#80cc45', hint: 'Difficult going, and it will be on your boots later.' },
    { id: 'warn', name: 'Warning light', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'panel', colors: ['#9b5a51', '#a46055'], emissive: '#eb3326', hint: 'Something down here is running.' },
    ...
    { id: 'tray', name: 'Cable-tray floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'panel', colors: ['#5c5440', '#6a614a'], hint: 'Trip hazard, and a decker will ask where it goes.' },
    ...
    // Every set has a street, a sidewalk and the kerb between them, and a light for indoors.
    { id: 'street', name: 'Service lane', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#565042', '#645d4d'] },
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#8a806a', '#978c75'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Caged bulb', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#6c634b', '#7a7056'], emissive: '#ffb84a', footprint: 'post', prop: 'pendant', placement: { on: ['duct', 'walkway', 'tray', 'warn'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
  ],
};
...
export const BARRENS: Tileset = {
  ...
  tiles: [
    ...
    { id: 'dirt', name: 'Packed dirt', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'dirt', colors: ['#624e3e', '#765e4b'] },
    { id: 'ash', name: 'Ash and soot', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'dirt', colors: ['#423c35', '#574e46'], hint: 'Something burned here and nobody came.' },
    { id: 'rubble', name: 'Rubble', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'rubble', colors: ['#7c6352', '#90725f'], hint: 'Rough going, and it crunches.' },
    { id: 'slab', name: 'Broken slab', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'concrete', colors: ['#765f51', '#8b705f'] },
    { id: 'weeds', name: 'Weed patch', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'grass', colors: ['#5e6744', '#707c52'] },
    ...
    // Every set has a street, a sidewalk and the kerb between them, and a light for indoors.
    { id: 'street', name: 'Cracked asphalt', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'gravel', colors: ['#4b4038', '#5a4d43'] },
    { id: 'sidewalk', name: 'Broken sidewalk', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#7f6c5d', '#8e7968'] },
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#8e7b6b', '#9c8877'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Hanging bulb', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#5f5146', '#6c5d51'], emissive: '#ffb056', footprint: 'post', prop: 'pendant', placement: { on: ['slab'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
  ],
};
...
export const CLUB: Tileset = {
  ...
  tiles: [
    ...
    { id: 'floor', name: 'Dance floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'tile', colors: ['#33444d', '#415662'], hint: 'Lit from below, and it moves.', sheen: '#b83cff' },
    { id: 'bar', name: 'Bar decking', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'planks', colors: ['#a07a56', '#a47f59'] },
    { id: 'quiet', name: 'Back-room floor', kind: 'floor', category: 'ground', setting: 'inside', pattern: 'carpet', colors: ['#6c7a81', '#7d8e96'], hint: 'Out of the noise. This is where the job gets described.' },
    ...
    // Every set has a street, a sidewalk and the kerb between them, and a light for indoors.
    { id: 'street', name: 'Street', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'gravel', colors: ['#35393d', '#42474c'] },
    { id: 'sidewalk', name: 'Sidewalk', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'tile', colors: ['#5e6a70', '#6a777e'] },
    { id: 'curb', name: 'Kerb', kind: 'floor', category: 'ground', setting: 'outside', pattern: 'concrete', colors: ['#737f85', '#7f8c92'], hint: 'A one-square row between the street and the sidewalk.' },
    { id: 'ceilinglight', name: 'Spot lamp', kind: 'feature', category: 'decoration', pattern: 'solid', colors: ['#3f4c55', '#4b5a64'], emissive: '#e6a340', footprint: 'post', prop: 'pendant', placement: { on: ['floor', 'bar', 'quiet'] }, hint: 'A ceiling light: lights the room from inside. Hangs overhead, so it gives no cover.' },
  ],
};
