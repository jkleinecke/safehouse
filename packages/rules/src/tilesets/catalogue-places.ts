...
export const TENEMENT: Tileset = {
  ...
  tiles: [
    ...
    { id: 'lino', name: 'Hallway lino', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#6f6350', '#7d705b'], hint: 'The landing. Scuffed to the pattern.' },
    { id: 'carpet', name: 'Apartment carpet', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#6e5646', '#7b6252'] },
    { id: 'kitchen', name: 'Kitchen vinyl', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#7e7358', '#8b8064'] },
    { id: 'bathroom', name: 'Bathroom tile', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#7a8078', '#888e86'], hint: 'The one cold floor in the flat.' },
    { id: 'landing', name: 'Bare concrete', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#615647', '#6e6252'] },
    { id: 'lamp', name: 'Bulb light pool', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#8c7454', '#957c5a'], emissive: '#ffb648', hint: 'One bare bulb per room. Paint two cells.' },
...
export const CONDO: Tileset = {
  ...
  tiles: [
    ...
    { id: 'lobbyfloor', name: 'Lobby marble', kind: 'floor', category: 'ground', pattern: 'marble', colors: ['#a09a8f', '#a9a398'], sheen: '#e0ce87', hint: 'Somebody polishes this at 04:00.' },
    { id: 'hallcarpet', name: 'Corridor carpet', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#7c7d81', '#87888c'] },
    { id: 'oak', name: 'Engineered oak', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#978e82', '#a1988c'] },
    { id: 'bathtile', name: 'Bathroom stone', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#93938f', '#9d9d99'] },
    { id: 'balcony', name: 'Balcony deck', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#77787c', '#828387'], hint: 'Forty floors up. Rope work starts here.' },
    { id: 'downlight', name: 'Downlight pool', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#9a9488', '#a49e92'], emissive: '#e6d58a' },
...
export const CAFE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'boards', name: 'Worn floorboards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7e6448', '#8b6f50'] },
    { id: 'chequer', name: 'Chequer tile', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#726a5c', '#7f7666'], hint: 'Two colours, once.' },
    { id: 'kitchen', name: 'Kitchen tile', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#7b7462', '#88816e'] },
    { id: 'pavement', name: 'Pavement out front', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#766a5a', '#837665'] },
    { id: 'mat', name: 'Door mat', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#6f5a44', '#7b654c'] },
    { id: 'warmlight', name: 'Pendant light pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#8f7452', '#997c58'], emissive: '#ffb648' },
...
export const RESTAURANT: Tileset = {
  ...
  tiles: [
    ...
    { id: 'marble', name: 'Marble floor', kind: 'floor', category: 'ground', pattern: 'marble', colors: ['#96938c', '#a09d96'], sheen: '#e0ce87' },
    { id: 'dining', name: 'Dining-room carpet', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#6e6f73', '#797a7e'] },
    { id: 'parquet', name: 'Parquet', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#8d8478', '#978e82'] },
    { id: 'kitchen', name: 'Kitchen tile', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#8c8c88', '#969692'] },
    { id: 'terrace', name: 'Terrace stone', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#8a8780', '#94918a'] },
    { id: 'candle', name: 'Candlelight pool', kind: 'floor', category: 'ground', pattern: 'carpet', colors: ['#8f8a82', '#99948c'], emissive: '#ffb648', hint: 'Paint one cell per table.' },
...
export const TAKEOUT: Tileset = {
  ...
  tiles: [
    ...
    { id: 'greasetile', name: 'Grease-dulled tile', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#77694f', '#847559'] },
    { id: 'kitchenfloor', name: 'Kitchen tread plate', kind: 'floor', category: 'ground', pattern: 'hatch', colors: ['#6c6252', '#786d5c'] },
    { id: 'pavement', name: 'Wet pavement', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#5d5348', '#6a5f52'], sheen: '#ff8a3c' },
    { id: 'alley', name: 'Back alley', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#4f4840', '#5c544b'] },
    { id: 'signspill', name: 'Sign spill', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#8a5f48', '#95684f'], emissive: '#ff5a3c', hint: 'The red of the sign on the pavement. Two cells.' },
...
export const PLAZA: Tileset = {
  ...
  tiles: [
    ...
    { id: 'setts', name: 'Granite setts', kind: 'floor', category: 'ground', pattern: 'cobble', colors: ['#766c5c', '#837866'], shore: 'quay' },
    { id: 'paving', name: 'Paving slabs', kind: 'floor', category: 'ground', pattern: 'tile', colors: ['#82796a', '#8f8574'], shore: 'quay' },
    { id: 'lawn', name: 'Clipped lawn', kind: 'floor', category: 'ground', pattern: 'grass', colors: ['#5c6a42', '#68774b'] },
    { id: 'basin', name: 'Fountain basin', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4a6064', '#576f74'], liquid: 'shallow', hint: 'Knee-deep. Reflects the lamps.' },
    { id: 'road', name: 'Plaza road', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#52493f', '#5f554a'], shore: 'quay' },
    { id: 'lamppool', name: 'Lamp pool', kind: 'floor', category: 'ground', pattern: 'cobble', colors: ['#8f7d5e', '#9a8766'], emissive: '#ffb648', shore: 'quay' },
...
export const PARK: Tileset = {
  ...
  tiles: [
    ...
    { id: 'grass', name: 'Park grass', kind: 'floor', category: 'ground', pattern: 'grass', colors: ['#5b6a42', '#67774b'] },
    { id: 'path', name: 'Gravel path', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#7f7461', '#8c806b'] },
    { id: 'dirt', name: 'Worn earth', kind: 'floor', category: 'ground', pattern: 'dirt', colors: ['#6f5f48', '#7c6a51'] },
    { id: 'pond', name: 'Pond', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#465c5c', '#536b6c'], liquid: 'deep', hint: 'Deeper than it looks, and the bottom is soft.' },
    { id: 'reeds', name: 'Pond margin', kind: 'floor', category: 'ground', pattern: 'reeds', colors: ['#5a6a4a', '#667753'], liquid: 'shallow' },
    { id: 'deck', name: 'Bandstand deck', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#83694a', '#8f7352'], shore: 'pier' },
    { id: 'lamppool', name: 'Path lamp pool', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#907d5e', '#9b8766'], emissive: '#ffb648' },
    { id: 'pierwall', name: 'Pier wall', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7a6448', '#866e50'], shore: 'pier', hint: 'A boardwalk over the pond: paint it along the water and it stands on posts, with a timber wall down to the surface.' },
    { id: 'beach', name: 'Beach front', kind: 'floor', category: 'ground', pattern: 'sand', colors: ['#8a7c62', '#97886c'], shore: 'beach', hint: 'Sand running under the water where the ducks get fed. Wet at the edge, a line of foam.' },
    { id: 'shallows', name: 'Shallow water', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4f6560', '#5c736d'], liquid: 'shallow', hint: 'Ankle-deep over mud. Paint it round the pond and the bottom shows through.' },
...
export const MARINA: Tileset = {
  ...
  tiles: [
    ...
    { id: 'planking', name: 'Pier planking', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7f6a4e', '#8b7556'], shore: 'pier' },
    { id: 'wetplank', name: 'Wet planking', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#5f5340', '#6a5d48'], sheen: '#ffb648', shore: 'pier', hint: 'Slick. The ruler does not care, but you might.' },
    { id: 'quay', name: 'Concrete quay', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#7a7060', '#877c6b'], shore: 'quay', hint: 'Along the water it drops as a coursed wall with a pale coping.' },
    { id: 'harbour', name: 'Harbour water', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#3e5559', '#4a6368'], liquid: 'deep', hint: 'Cold and deep. Swimming is a test.' },
    { id: 'shallows', name: 'Shallows', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4f6466', '#5c7274'], liquid: 'shallow' },
    { id: 'slipway', name: 'Slipway', kind: 'floor', category: 'ground', pattern: 'concrete', colors: ['#6a6759', '#777463'], shore: 'beach', hint: 'A ramp that runs under the water — no wall, so a boat comes straight up it.' },
    { id: 'docklamp', name: 'Dock lamp pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#907a58', '#9b8460'], emissive: '#ffb648', shore: 'pier' },
    { id: 'pierwall', name: 'Pier wall', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#6f5c43', '#7b674b'], shore: 'pier', hint: 'The deck edge over the harbour: a timber wall on pilings, a capping beam. Paint it where the boards meet the water.' },
    { id: 'beach', name: 'Beach front', kind: 'floor', category: 'ground', pattern: 'sand', colors: ['#7d715c', '#8a7d66'], shore: 'beach', hint: 'Shingle running down under the water. Boats come up here; so does everything the tide brings.' },
...
export const COUNTRYSIDE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'meadow', name: 'Meadow', kind: 'floor', category: 'ground', pattern: 'grass', colors: ['#66713f', '#727f48'] },
    { id: 'crops', name: 'Crop rows', kind: 'floor', category: 'ground', pattern: 'field', colors: ['#6c5f42', '#78694a'] },
    { id: 'track', name: 'Dirt track', kind: 'floor', category: 'ground', pattern: 'dirt', colors: ['#74624a', '#816d52'] },
    { id: 'yard', name: 'Farmyard gravel', kind: 'floor', category: 'ground', pattern: 'gravel', colors: ['#7f7463', '#8c806e'] },
    { id: 'barnfloor', name: 'Barn boards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7b6446', '#876e4e'] },
    { id: 'pond', name: 'Farm pond', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4c5f56', '#586d63'], liquid: 'deep' },
    { id: 'porchlight', name: 'Porch light pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#907a57', '#9b845f'], emissive: '#e6d58a' },
...
export const LAKE: Tileset = {
  ...
  tiles: [
    ...
    { id: 'shore', name: 'Shingle shore', kind: 'floor', category: 'ground', pattern: 'sand', colors: ['#847660', '#91826a'], shore: 'beach' },
    { id: 'jetty', name: 'Jetty boards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#7f6a4e', '#8b7556'], shore: 'pier' },
    { id: 'cabinfloor', name: 'Cabin boards', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#846b4a', '#907552'], shore: 'pier' },
    { id: 'deep', name: 'Deep water', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#364e55', '#425c63'], liquid: 'deep', hint: 'Black at night. Anything dropped here is gone.' },
    { id: 'shallow', name: 'Shallows', kind: 'floor', category: 'ground', pattern: 'water', colors: ['#4d6266', '#5a7074'], liquid: 'shallow' },
    { id: 'reeds', name: 'Reed bed', kind: 'floor', category: 'ground', pattern: 'reeds', colors: ['#5a6748', '#667551'], liquid: 'shallow', hint: 'Cover for a boat, and for whoever is waiting in one.' },
    { id: 'pine', name: 'Pine needles', kind: 'floor', category: 'ground', pattern: 'dirt', colors: ['#6a5a45', '#77664d'] },
    { id: 'lamppool', name: 'Lantern pool', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#917a56', '#9c845e'], emissive: '#e6d58a', shore: 'pier' },
    { id: 'pierwall', name: 'Pier wall', kind: 'floor', category: 'ground', pattern: 'planks', colors: ['#766347', '#826d4f'], shore: 'pier', hint: 'Where the jetty meets the lake: boards down to the water on round posts.' },
    { id: 'beach', name: 'Beach front', kind: 'floor', category: 'ground', pattern: 'sand', colors: ['#8b7d63', '#98896d'], shore: 'beach', hint: 'Pale sand under the shallows. The only way a boat lands quietly.' },
